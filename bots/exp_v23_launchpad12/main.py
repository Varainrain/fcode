...
class Player:
    ...
    def _build_launchpad(self, ct: Controller, myLoc: Position) -> bool:
        ...
        # DO NOT BLOCK THE DOOR. Picking the tile closest to their core puts the
        # pad squarely on the lane every builder walks out through, and our own
        # buildings block our own units - traced as b3 oscillating 22<->21 for
        # eight turns in v11 where the pad-less parent marched straight out.
        # Prefer a tile beside the exit lane: still in pickup range of departing
        # builders, never standing in their way.
        ...
        for d in CARDINALS:
            ...
            if not ct.can_build_launcher(spot):
                continue
            # offset perpendicular to the core->enemy axis
