...
class Player:
    ...
    def runCore(self, ct: Controller) -> None:
        ...
        # A4: the 16-ammo cap is a team-wide firepower throttle. A gunner shot
        # costs 4 ammo, so a 16 pool is 4 shots per turn for the WHOLE team -
        # our attackers measured 19.2% of their turns with the pool under one
        # shot. A deeper buffer banks titanium as burst capacity (v44 used 60).
