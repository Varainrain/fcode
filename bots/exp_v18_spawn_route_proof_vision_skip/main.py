...
class Player:
    ...
    def getDefendHome(self, ct: Controller):
        ...
        # If the whole ring is still outside vision, approach the known core
        # without caching an assumed-empty home tile. Recompute once nearby.
        return self.defendHome if self.defendHome is not None else teamCore
