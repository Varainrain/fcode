# v18 spawn discipline + route proof + vision-safe return
...
The home planner never queries or caches a core-ring tile outside current
vision. A distant defender approaches the known core coordinate, then chooses
its original ranked ring position once the ring is actually visible.
