# v18 spawn-discipline experiment

Independent from the active v18 source. The first four builders and their roles
are unchanged. Later spawning pauses only while six friendly builders are
already inside core vision, and resumes after they disperse or die.
