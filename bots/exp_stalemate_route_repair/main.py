...
class Player:
    ...
    def runBestState(self, ct: Controller, myLoc: Position):
        ...
        # Preserve the parent's full normal combat window. Only in a surviving
        # round-300 stalemate may one builder repair an already-built mine.
