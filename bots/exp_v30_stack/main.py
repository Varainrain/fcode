...
BOLT_BAND = 9   # start seat-hunting only this close (firing band is 6)
# STACKED with deferred defence. Neither passed alone (bolt 52%, defer 49%), so
# WORKFLOW would normally forbid stacking, but they are complementary rather
# than overlapping: defer stops the OPENING GUN BUDGET going to home defence,
# bolt stops the WALK being wasted, and each independently moves first gun
# t29 -> t25.
DEFENSE_HOLD_SLOT = 11
DEFENSE_HOLD_MIN_THREATS = 2
