...
SLOT_HOME_THREAT = 15
# SPARRING PARTNER, NOT A CANDIDATE. The ladder's top two put a gun on the
# enemy core at t19-t24 and no bot in bots/ does anything like it, so no local
# gate could see how we fare against a rush. This is the cheapest honest proxy:
# our own engine dispatched almost immediately. Do not submit it, do not stack
# it - it exists so early-defence claims can be measured instead of asserted.
SIEGE_START = 5
