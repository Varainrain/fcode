# v18 legal build-stand experiment

Independent from the active v18 source. Production 2.3.3 permits builder
construction only from an orthogonally adjacent tile. Attackers standing on a
planned gun seat and economy builders standing on ore now step off one tile and
build next turn instead of retreating to their own core.
