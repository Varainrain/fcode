    ...
    def runGunner(self, ct: Controller):
        ...
        for directionIndex, d in enumerate(DIRECTIONS):
            ...
            for tile in ct.get_attackable_tiles_from(myPos, d, EntityType.GUNNER):
                # A8: enemy BUILDERS are what seat their guns and heal their
                # core, and this scorer never saw them - only buildings. A
                # facing covering two enemy builders scored 0 while a facing
                # covering one enemy conveyor scored 1 and won the rotation.
