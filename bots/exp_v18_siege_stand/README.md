# v18 legal siege-stand experiment

Independent from active v18. An attacker standing on its planned gun seat now
steps one cardinal tile behind it, allowing the production-legal adjacent build
next turn, instead of abandoning the siege and walking home.
