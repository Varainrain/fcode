...
LK_CORES = {
    ...
    # valkyrie CARVED to eco (08-17 night): lkick 0/4 vs waves there, band is
    # wave-heavy (kladde/Bisons/OpenSverige). nordkap/fjordgate STAY lkick:
    # our eco went 0/6 vs the launcher-rush class on the whole trio, so the
    # full carve would have traded a coinflip for an auto-loss vs linglings.
}
