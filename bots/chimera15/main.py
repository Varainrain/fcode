...
# CARVED 08-17 night (field sweeps 332b3f7f/f4a30730/e3167987 + targeted
# referee): valkyrie OUT (lkick 0/4 vs waves; our eco 78% there; lingling
# killed it t60), nordkap+fjordgate OUT (lkick mixed 7-8/12 vs military,
# lingling's tighter launcher rush beat it t46-85; our eco read 60% vs the
# same class). MIRROR-DATA TRAP, round 2: lkick sweeping OUR eco on a map
# does not mean lkick beats the FIELD there - same anti-correlation as
# fen2. lingling = launcher-kick rusher class, out-executes v143's own
# game on small maps.
LK_CORES = {
