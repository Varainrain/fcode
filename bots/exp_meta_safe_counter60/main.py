...
def home_counter_budget_allows(resources: int, bounded_trade: bool) -> bool:
    # A verified, zero-exposure home counter should not wait for the forward
    # siege reserve. The responder stops spending after one covering gun.
    return bounded_trade or resources > SAFE_HOME_COUNTER_FLOOR
