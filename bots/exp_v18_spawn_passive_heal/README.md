# v18 spawn discipline + passive heal

Independent child of `bots/exp_v18_spawn_discipline`. After normal role logic,
a builder with a spare action and more than 28 Ti may heal one adjacent friendly
building. It prioritizes core, turrets, economy, conveyors, then barriers. Role
selection, movement, combat, routing, and spawning are otherwise unchanged.
