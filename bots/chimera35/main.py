...
class Player:
    ...
    def run_core(self, ct: Controller) -> None:
        ...
        # enemy turret in core vision. Flotte's lean line (dbc7e6c5 g1) put
        # a sentinel on our core at t114 and killed by t158 with our healers
        # 15 tiles away - hp-based recall fires ~60 turns too late on big
        # maps. Persistence >= 10 = a LINE is coming; muster before it lands.
        if enemyTurretSeen:
