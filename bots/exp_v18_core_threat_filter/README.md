# v18 core-threat filter experiment

Independent from the active v18 source. The designated home defender reacts
only to an enemy gunner or sentinel whose current attack pattern reaches a tile
of the friendly core; unrelated visible turrets no longer pull it away.
