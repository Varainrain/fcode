# v18 firing-line integrity experiment

Independent from the active v18 source. It rejects builder-occupied siege
seats, measures defensive coverage with `can_fire_from`, includes friendly
builders in ray blocking, and scores only the first occupied tile of a gunner
ray instead of enemies hidden behind friendly blockers.
