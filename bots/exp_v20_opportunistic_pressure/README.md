# v20 near-core finish + opportunistic core pressure
...
On top of near-core repair, defenders and economy builders may build a direct
enemy-core gun before counter-battery when a safe legal placement is available
this turn. They never travel or change role for it. This ports Pantheon's
attack-first state ceiling to the production gun-race failure without a map or
