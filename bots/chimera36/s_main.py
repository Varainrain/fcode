...
class Player:
    ...
    def run(self, ct: Controller) -> None:
        ...
        if etype == EntityType.CORE:
            ...
            # TRIAGE HEAL (8cdcc379 g3, user-found: enemy builders chew our
            # seated gunners 2/turn and static-facing guns can't answer).
            # HEAL BEATS CHEW: builder heal is 4/turn - one heal every other
            # turn keeps a chewed gunner alive forever WHILE IT KEEPS FIRING.
            # Only for genuinely endangered guns (hp<=15) so building the
            # next seat stays the priority; 1 Ti per heal, no facing touched,
            # no race tax - offense-PRESERVING defense.
            _tri = None
            _triHp = 16
