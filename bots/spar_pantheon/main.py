...
class Player:
    ...
    def _is_sieger(self, ct: Controller) -> bool:
        # SPARRING PROFILE: everyone sieges. Pantheon puts 89% of its guns
        # within 6 of the enemy core and 1% in its own half; two designated
        # siegers cannot produce that distribution.
        return True

    def _is_sieger_unused(self, ct: Controller) -> bool:
    ...
    def runBestState(self, ct: Controller, myLoc: Position):
        ...
        # SPARRING PROFILE: Pantheon runs ~18 conveyors and ~4 harvesters to our
        # ~94 and ~6.5. Economy states are damped, not removed - it still needs
        # income to pay for guns.
        harvestScore *= 0.85
        routeScore *= 0.45
