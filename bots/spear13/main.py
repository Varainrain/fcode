            ...
            if cands:
                ...
                if latched is not None:
                    ...
                    if still_ok:
                        ...
                        # BAIL FAST. Measured (match 0772902b g2): one seat
                        # went down at t19 and the builder then sat near
                        # (7,13) for the rest of the game with three seats
                        # unplaced - the target was unreachable and we
                        # waited a quarter of the match to admit it. Give up
                        # after 8 turns, or after 3 turns of not moving at
                        # all, and take the next candidate - there are seats
                        # on every side of their core.
                        if self.seat_wait > 8 or self.stuck >= 3:
                            still_ok = False
