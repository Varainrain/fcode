...
RB_CORES = {
    (20, 20): frozenset({(9, 1), (9, 17)}),     # auroraveil (rb 6/6 t44)
    (30, 30): frozenset({(14, 2), (14, 26),     # glacierkeep (rb 6/6 t50)
                         (2, 24), (26, 4)}),    # drakkarfjord (rb 6/6 t58)
    (25, 25): frozenset({(5, 5), (18, 18)}),    # drumlin (rb 6/6 t40)
}
