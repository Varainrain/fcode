"""Deterministic mechanism tests for exp_late_route_repair."""
...
BOT_DIR = ROOT / "bots" / "exp_late_route_repair"
...
def load_bot():
    ...
    try:
        spec = importlib.util.spec_from_file_location(
            "late_route_repair_main", BOT_DIR / "main.py")
...
if __name__ == "__main__":
    ...
    print("late route repair tests passed")
