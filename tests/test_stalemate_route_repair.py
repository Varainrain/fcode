"""Deterministic mechanism tests for exp_stalemate_route_repair."""
...
BOT_DIR = ROOT / "bots" / "exp_stalemate_route_repair"
...
def load_bot():
    ...
    try:
        spec = importlib.util.spec_from_file_location(
            "stalemate_route_repair_main", BOT_DIR / "main.py")
...
if __name__ == "__main__":
    ...
    print("stalemate route repair tests passed")
